...
[![CI](https://github.com/kian-malekzadeh/Kia-Acad/actions/workflows/ci.yml/badge.svg)](https://github.com/kian-malekzadeh/Kia-Acad/actions/workflows/ci.yml)
...
**[🌐 Live Demo](https://kian-malekzadeh.github.io/Kia-Acad/)** &nbsp;·&nbsp;
**[📦 Repository](https://github.com/kian-malekzadeh/Kia-Acad)** &nbsp;·&nbsp;
**[🐞 Issues](https://github.com/kian-malekzadeh/Kia-Acad/issues)** &nbsp;·&nbsp;
...
```bash
git clone https://github.com/kian-malekzadeh/Kia-Acad.git Kia-Academy
cd Kia-Academy
...
| D — Static Pages export | `pnpm build:pages` | demo mode, basePath `/Kia-Acad` |
